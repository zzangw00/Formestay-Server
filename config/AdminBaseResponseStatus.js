module.exports = {
    ...
    // Admin Request error
    ADMIN_SIGNUP_EMAIL_EMPTY: { isSuccess: false, code: 2101, message: '이메일을 입력해주세요' },
    ...
    ADMIN_SIGNIN_EMAIL_EMPTY: { isSuccess: false, code: 2107, message: '이메일을 입력해주세요' },
    ...
    SIGNIN_USERINFO_WRONG: {
        isSuccess: false,
        code: 3010,
        message: '아이디 또는 비밀번호가 일치하지 않습니다.',
    },
    // Admin Response error
    ADMIN_SIGNUP_REDUNDANT_EMAIL: { isSuccess: false, code: 3101, message: '중복된 이메일입니다.' },
